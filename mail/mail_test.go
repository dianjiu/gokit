...
func prepareEmail() *Email {
	e := NewEmail()
	e.From = "Gitlab <gitlab@dianjiu.cc>"
	e.To = []string{"468792388@qq.com"}
	e.Bcc = []string{"468792388@qq.com"}
	e.Cc = []string{"468792388@qq.com"}
	e.Subject = "Test GotoolSend Mail"
	return e
}
...
func basicTests(t *testing.T, e *Email) *mail.Message {
	...
	expectedHeaders := map[string]string{
		"To":      "<468792388@qq.com>",
		"From":    "\"Gitlab\" <gitlab@dianjiu.cc>",
		"Cc":      "<468792388@qq.com>",
		"Subject": "Test GotoolSend Mail",
	}
